...
# step 1 : choose the right option from the below
# Y = np.reshape(escaped_list, (len(escaped_list), 0))
# Y = np.reshape(escaped_list, (len(escaped_list)-1, 1))
# Y = np.shape(escaped_list, (len(escaped_list), 1))
